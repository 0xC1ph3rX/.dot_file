return {
...

	{
		...
		opts = {
			ensure_installed = { "bash", "c", "cpp", "html", "lua", "markdown", "vim", "vimdoc", "python", "go" },
			auto_install = true,
			highlight = {
				enable = true,
		...
		config = function(_, opts)
			...
			local ok_rewrite, rewrite = pcall(require, "nvim-treesitter")
			if ok_rewrite and type(rewrite.setup) == "function" then
				rewrite.setup(opts)
			end
		end,
	},
